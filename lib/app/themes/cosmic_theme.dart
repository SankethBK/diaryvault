    ...
    return ThemeData(
      ...
      extensions: <ThemeExtension<dynamic>>{
        AuthPageThemeExtensions(
          ...
          authFormGradientEndColor: Colors.black.withValues(alpha: 0.3),
        ...
        AppbarThemeExtensions(
          ...
          appBarGradientStartColor: Colors.black.withValues(alpha: 0.3),
          appBarGradientEndColor: Colors.black.withValues(alpha: 0.2),
          searchBarFillColor: Colors.white.withValues(alpha: 0.1),
        ),
        HomePageThemeExtensions(
          borderColor: Colors.black,
          backgroundGradientStartColor: Colors.black.withValues(alpha: 0.8),
          backgroundGradientEndColor: Colors.black.withValues(alpha: 0.6),
          ...
          notePreviewSelectedGradientStartColor:
              const Color.fromARGB(255, 36, 46, 178).withValues(alpha: 0.5),
          notePreviewSelectedGradientEndColor:
              const Color.fromARGB(255, 36, 46, 178).withValues(alpha: 0.2),
          checkBoxSelectedColor: Colors.blueAccent,
        ),
        NoteCreatePageThemeExtensions(
          fallbackColor: const Color.fromARGB(255, 48, 140, 221),
          titleTextBoxFillColor: Colors.black.withValues(alpha: 0.4),
          titleTextBoxBorderColor: Colors.white.withValues(alpha: 0.5),
          ...
          toolbarGradientStartColor: Colors.black.withValues(alpha: 0.75),
          toolbarGradientEndColor: Colors.black.withValues(alpha: 0.6),
          ...
          richTextGradientStartColor: Colors.black.withValues(alpha: 0.7),
          richTextGradientEndColor: Colors.black.withValues(alpha: 0.5),
