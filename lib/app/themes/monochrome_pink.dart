...
// ############## Change color to Color.fromARGB and add const value
      ...
      canvasColor: Colors.pink.withValues(alpha: 0.3),
      ...
      extensions: <ThemeExtension<dynamic>>{
        AuthPageThemeExtensions(
          ...
          fillColor: const Color(0xFFff9bd2).withValues(alpha: 0.2),
          borderColor: const Color(0xFFff9bd2).withValues(alpha: 0.4),
          textColor: Colors.white.withValues(alpha: 1),
          hintTextColor: Colors.white.withValues(alpha: 0.7),
          authFormGradientStartColor: Colors.pink.withValues(alpha: 0.5),
          authFormGradientEndColor:
              const Color.fromARGB(255, 83, 51, 51).withValues(alpha: 0.3),
          infoTextColor: Colors.white.withValues(alpha: 0.8),
        ),
        ChipThemeExtensions(
          backgroundColor: const Color.fromARGB(255, 248, 129, 194),
          iconColor: Colors.pink.withValues(alpha: 0.5),
        ...
        HomePageThemeExtensions(
          borderColor: const Color(0xFFff9bd2).withValues(alpha: 0.1),
          backgroundGradientStartColor:
              const Color(0xFFd63484).withValues(alpha: 0.5),
          backgroundGradientEndColor: const Color(0xFFd63484).withValues(alpha: 0.2),
          ...
          sigmaX: 5.0,
          sigmaY: 5.0,
          notePreviewBorderColor: Colors.black.withValues(alpha: 0.3),
          ...
          notePreviewSelectedGradientStartColor:
              const Color.fromARGB(255, 240, 92, 142).withValues(alpha: 0.5),
          notePreviewSelectedGradientEndColor: Colors.pink.withValues(alpha: 0.2),
          checkBoxSelectedColor: Colors.pinkAccent,
        ),
        NoteCreatePageThemeExtensions(
          fallbackColor: const Color.fromARGB(255, 48, 140, 221),
          titleTextBoxFillColor: const Color(0xFFd63484).withValues(alpha: 0.4),
          titleTextBoxBorderColor: Colors.white.withValues(alpha: 0.3),
          titleTextBoxFocussedBorderColor: Colors.white.withValues(alpha: 0.7),
          ...
          toolbarGradientStartColor: const Color(0xFFd63484).withValues(alpha: 0.5),
          toolbarGradientEndColor: const Color(0xFFd63484).withValues(alpha: 0.45),
          ...
          richTextGradientStartColor: const Color(0xFFd63484).withValues(alpha: 0.5),
          richTextGradientEndColor: const Color(0xFFd63484).withValues(alpha: 0.3),
        ...
        PopupThemeExtensions(
          ...
          popupGradientStartColor:
              const Color.fromARGB(255, 246, 118, 203).withValues(alpha: 0.7),
          popupGradientEndColor:
              const Color.fromARGB(255, 246, 118, 203).withValues(alpha: 0.4),
          mainTextColor: Colors.white,
        ),
