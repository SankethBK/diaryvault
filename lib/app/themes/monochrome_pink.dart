...
// ############## Change color to Color.fromARGB and add const value
      ...
      extensions: <ThemeExtension<dynamic>>{
        ...
        NoteCreatePageThemeExtensions(
          ...
          titleTextBoxFillColor: const Color(0xFFff9bd2).withOpacity(0.2),
          ...
          toolbarGradientStartColor: const Color(0xFFff9bd2).withOpacity(0.5),
          toolbarGradientEndColor: const Color(0xFFff9bd2).withOpacity(0.5),
          ...
          richTextGradientStartColor: const Color(0xFFff9bd2).withOpacity(0.5),
          richTextGradientEndColor: const Color(0xFFff9bd2).withOpacity(0.3),
