    ...
    return ThemeData(
      ...
      extensions: <ThemeExtension<dynamic>>{
        AuthPageThemeExtensions(
          ...
          infoTextColor: Colors.white.withValues(alpha: 0.7),
        ),
        ChipThemeExtensions(
        ...
        HomePageThemeExtensions(
          ...
          backgroundGradientStartColor: Colors.white.withValues(alpha: 0.6),
          backgroundGradientEndColor: Colors.white.withValues(alpha: 0.4),
          previewTitleColor: Colors.black87,
          previewBodyColor: Colors.black87,
          dateColor: Colors.black54,
          sigmaX: 5.0,
          sigmaY: 5.0,
          notePreviewBorderColor: Colors.white.withValues(alpha: 0.4),
          ...
          notePreviewSelectedGradientEndColor:
              Colors.indigo[700]!.withValues(alpha: 0.2),
          checkBoxSelectedColor: Colors.orangeAccent,
        ),
        NoteCreatePageThemeExtensions(
          fallbackColor: const Color.fromARGB(225, 234, 94, 141),
          titleTextBoxFillColor: Colors.white.withValues(alpha: 0.6),
          titleTextBoxBorderColor: Colors.indigo[700]!.withValues(alpha: 0.7),
          titleTextBoxFocussedBorderColor: Colors.orangeAccent,
          titlePlaceHolderColor: Colors.black54,
          titleTextColor: Colors.black87,
          toolbarGradientStartColor: Colors.white.withValues(alpha: 0.5),
          toolbarGradientEndColor: Colors.white.withValues(alpha: 0.5),
