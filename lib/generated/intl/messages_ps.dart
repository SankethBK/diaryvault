...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(imported, skipped, failed) =>
      "وارد شوي ${imported} یادښتونه، پریښودل شوی ${skipped} موجوده، ${failed}";

  static String m1(imported, skipped) =>
      "وارد شوي ${imported} یادښتونه، له ${skipped} شته یادښتونه";

  static String m2(count) => "وارد شوي ${count} یادښتونه";

  static String m3(time) => "تاسو ته به په ${time} کې خبر درکړل شي";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "alreadyHaveAnAccount": MessageLookupByLibrary.simpleMessage(
      "تاسو دمخه د Uber یو حساب لرئ. ",
    ),
    "appDescription": MessageLookupByLibrary.simpleMessage(
      "ډائري والټ کشف کړئ - یو ډائري ایپ چې تاسو سره ستاسو د افکارو، خاطرو او شیبو په اسانۍ سره په ترلاسه کولو کې د مرستې لپاره ډیزاین شوی. اوس په Play Store کې شتون لري!",
    ),
    ...
    "customThemeIntro": MessageLookupByLibrary.simpleMessage(
      "یو عکس غوره کړئ چې تاسو یې خوښوئ یا د شالید رنګ غوره کړئ، او موږ به یې شاوخوا یوه موضوع جوړ کړو.",
    ),
    "customThemes": MessageLookupByLibrary.simpleMessage("دودیزې ویینې"),
    "dailyReminders": MessageLookupByLibrary.simpleMessage("ورځني یادښتونه"),
    "darkLabel": MessageLookupByLibrary.simpleMessage("تاریک"),
    "darkTheme": MessageLookupByLibrary.simpleMessage("تیاره ویینه"),
    "dateFilter": MessageLookupByLibrary.simpleMessage("د فلټر نیټه"),
    "defaultThemeName": MessageLookupByLibrary.simpleMessage("زما ویینه"),
    "delete": MessageLookupByLibrary.simpleMessage("ختمول"),
    "deletionFailed": MessageLookupByLibrary.simpleMessage(
      "د ليک ړنګېدنه پاتې راغله",
    ),
    ...
    "editTheme": MessageLookupByLibrary.simpleMessage("ویینې پلورنځي سمون"),
    "emailUpdatedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "بریښنالیک په بریالیتوب سره تازه شو، مهرباني وکړئ بیا ننوځئ",
    ),
    "enableAutoSave": MessageLookupByLibrary.simpleMessage(
      "خپل-ساتنه توانول/apps/openoffice/auto_save_interval\", _(\"Auto save interval\"), \"oooio",
    ),
    "enableDailyReminders": MessageLookupByLibrary.simpleMessage(
      "ورځنۍ یادونې فعالې کړئ",
    ),
    ...
    "noteUpdatedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "یادښت په بریالیتوب سره تازه شو",
    ),
    ...
    "tapToExpandTitle": MessageLookupByLibrary.simpleMessage(
      "د سرلیک پراخولو لپاره دلته کلیک وکړئ",
    ),
    "themeFontsAndLanguage": MessageLookupByLibrary.simpleMessage(
      "ویینه، ليکبڼه او ژبه خپلخوښه کړئ",
    ),
    "themeName": MessageLookupByLibrary.simpleMessage("ویینه نوم"),
    "themeNameHint": MessageLookupByLibrary.simpleMessage("زما ویینه"),
    "to": MessageLookupByLibrary.simpleMessage("په خدمت کې"),
    "tooManyWrongAttempts": MessageLookupByLibrary.simpleMessage(
      "ډیرې غلطې هڅې، مهرباني وکړئ د پاسورډ سره ننوځئ",
    ),
