...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(imported, skipped, failed) =>
      "${imported} గమనికలు దిగుమతి చేయబడ్డాయి, ${skipped} ఇప్పటికే ఉన్నాయి, ${failed} విఫలమైంది";

  static String m1(imported, skipped) =>
      "${imported} గమనికలు దిగుమతి చేయబడ్డాయి, ${skipped} ఇప్పటికే ఉన్న గమనికలు దాటవేయబడ్డాయి";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    "accent": MessageLookupByLibrary.simpleMessage("యాక్సెంట్"),
    "accountSetupSuccessful": MessageLookupByLibrary.simpleMessage(
      "ఖాతా సెటప్ విజయవంతమైంది",
    ),
    ...
    "chooseTheme": MessageLookupByLibrary.simpleMessage("థీమ్‌ని ఎంచుకోండి"),
    ...
    "customThemes": MessageLookupByLibrary.simpleMessage("అనుకూల థీమ్ ‌ లు"),
    ...
    "resetPin": MessageLookupByLibrary.simpleMessage("పిన్ ‌ ను రీసెట్ చేయండి"),
    ...
    "signedInAs": MessageLookupByLibrary.simpleMessage("గా సైన్ ఇన్ చేసారు"),
    "sortByAtoZ": MessageLookupByLibrary.simpleMessage(
      "A-Z ద్వారా క్రమబద్ధీకరించు",
    ),
